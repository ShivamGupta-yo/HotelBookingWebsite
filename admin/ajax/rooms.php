...
if (isset($_POST['add_room'])) {
    ...
    $room_id = mysqli_insert_id($con); //get the id of inserted data
...
if (isset($_POST['get_all_rooms'])) {
    ...
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        <button type="button" onclick="room_images($row[id],'$row[name]')" class="btn btn-info btn-sm mt-sm-1" data-bs-toggle="modal" data-bs-target="#room-images">
...
if (isset($_POST['get_room_images'])) {
    ...
    <td>$thumb_btn</td>
    <td>
    <button onclick='rem_image($row[sr_no],$row[room_id])' class='btn btn-danger '>
