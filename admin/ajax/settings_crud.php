...
if (isset($_POST['upd_contacts'])) {
    ...
    $q = "UPDATE `contact_details` SET `address`=?,`gmap`=?,`pn1`=?,`pn2`=?,`email`=?,`insta`=?,`git`=?,`ln`=? WHERE `sr_no`=?";
    $values = [$frm_data['address'], $frm_data['gmap'], $frm_data['pn1'], $frm_data['pn2'], $frm_data['email'], $frm_data['insta'], $frm_data['git'], $frm_data['ln'], 1];
